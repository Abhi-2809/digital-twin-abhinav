...
def list_events(
    ...
    try:
        ...
        time_min = start_datetime.isoformat() + 'Z' if start_datetime.tzinfo is None else start_datetime.isoformat()
        time_max = end_datetime.isoformat() + 'Z' if end_datetime.tzinfo is None else end_datetime.isoformat()
...
def create_event(
    ...
    try:
        ...
        event_body = {
            'summary': summary,
            'start': {
                'dateTime': start_datetime.isoformat() + 'Z' if start_datetime.tzinfo is None else start_datetime.isoformat(),
                'timeZone': 'UTC',
            },
            'end': {
                'dateTime': end_datetime.isoformat() + 'Z' if end_datetime.tzinfo is None else end_datetime.isoformat(),
                'timeZone': 'UTC',
            },
        }
